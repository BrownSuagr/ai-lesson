...
![image-20220111094748806](media/image-20220111094748806.png)

![image-20220111094815762](media/image-20220111094815762.png)
...
![image-20220111095035643](media/image-20220111095035643.png)

这种表结构设计就没有达到 1NF，要符合 1NF 我们只需把字段拆分，即：把 contact 字段拆分成 name 、tel、addr 等字段。

![image-20220111095043738](media/image-20220111095043738.png)
...
![image-20220111095145466](media/image-20220111095145466.png)

OrderDetail表的主键是什么？

主键的定义：能够确定唯一一行记录的特殊字段

![image-20220111095205270](media/image-20220111095205270.png)
...
![image-20220111095248873](media/image-20220111095248873.png)

这里有主键由OrderID和ProductID共同组成

同时 UnitPrice 和 ProductName 这里两个字段 与ProductID的从属关系强于他们同OrderID的从属关系 

![image-20220111095302986](media/image-20220111095302986.png)
...
![image-20220111095424576](media/image-20220111095424576.png)
...
![image-20220111095444389](media/image-20220111095444389.png)
...
![image-20220111095817454](media/image-20220111095817454.png)
...
- 一对一
  ...
  ![image-20220111095929110](media/image-20220111095929110.png)

- 一对多(1-n)

  ![image-20220111095943842](media/image-20220111095943842.png)

- 多对多(m-n)

  ![image-20220111095957194](media/image-20220111095957194.png)
