...
- 数据调研
  ...
  - 明确对目标人群有哪些可用数据, 明确数据获取逻辑
    ...
    ![image-20200831040930236](img/数据1.png)

    ![image-20200831041116225](img/数据2.png)

  - 明确数据的质量，覆盖度，稳定性

    ![image-20200831041946725](img/数据3.png)
...
- 特征构建
  ...
  - 明确数据源对应的具体数据表
    ...
    ![image-20200831042703020](img/数据4.png)
  ...
  - 画出类ER图  数据关系 一对一，一对多，多对多
    ...
    ![image-20200831043440159](img/数据5.png)
